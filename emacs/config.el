...
;;      (if (> (x-display-pixel-width) 3000)
      (if (> (nth 3 (assq 'geometry (frame-monitor-attributes))) 3000)
        (set-frame-parameter frame 'font "DejaVuSansMono Nerd Font 34") ;; laptop screen
          ;; (setq doom-font (font-spec :family "DejaVuSansMono Nerd Font" :size 34 :weight 'semi-light))
